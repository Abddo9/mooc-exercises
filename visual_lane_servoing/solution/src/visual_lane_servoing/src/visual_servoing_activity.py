...
def get_steer_matrix_left_lane_markings(shape):
    ...
    steer_matrix_left_lane[:,int(shape[1]*1/3):] = -0.008 # best values sim -3,-2.9:: -0.01 for the robot
...
def get_steer_matrix_right_lane_markings(shape):
    ...
    steer_matrix_right_lane[:,:int(shape[1]*2/3)] = 0.008  #best values sim 3, 2.9:: 0.01 for the robot
